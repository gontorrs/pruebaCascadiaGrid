...
public class SimpleGameController {
  ...
  private static void graphicBoard(ApplicationContext context) {
    ...
    var animalImages = new String[]{"bear.png", "elk.png", "fox.png", "eagle.png", "salmon.png", "blank.png"};
    var habitatImages = new String[]{"mountain.png", "forest.png", "river.png", "grassland.png", "wetland.png", "blank.png"};
